...
public class CustomListeners extends Page implements ITestListener, ISuiteListener {
	...
	public void onTestFailure(ITestResult arg0) {
		...
		Reporter.log("<br>");
		Reporter.log("<br>");
		Reporter.log("<a target=\"blank\" href=" + Utilities.screenshotName + "><img src=" + Utilities.screenshotName
	...
	public void onFinish(ITestContext context) {
		  ...
		  ":8080/job/LiveProject-PageObjectWithFactories/Extent_20Report/"; 
		  } 
